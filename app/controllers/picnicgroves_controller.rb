class PicnicgrovesController < ApplicationController
  ...
  private
    ...
    def picnicgrofe_params
      params.require(:picnicgrofe).permit(:picnicgrove_id, :preserve_name, :grove, :division, :capacity, :large_capacity, :picnicgrove_type, :location, :status, :fpd_uid, :poi_info_id, :geom)
    end
end
