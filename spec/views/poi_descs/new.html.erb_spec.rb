...
RSpec.describe "poi_descs/new", type: :view do
  before(:each) do
    assign(:poi_desc, PoiDesc.new(
      :poi_info_id => 1,
      :hours1 => "MyString",
      :hours2 => "MyString",
      :phone => "MyString",
  ...
  it "renders new poi_desc form" do
    render

    assert_select "form[action=?][method=?]", poi_descs_path, "post" do
