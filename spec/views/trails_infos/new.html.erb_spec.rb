...
RSpec.describe "trails_infos/new", type: :view do
  before(:each) do
    assign(:trails_info, TrailsInfo.new(
  ...
  it "renders new trails_info form" do
    render

    assert_select "form[action=?][method=?]", trails_infos_path, "post" do
