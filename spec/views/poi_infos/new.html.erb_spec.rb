...
RSpec.describe "poi_infos/new", type: :view do
  before(:each) do
    assign(:poi_info, PoiInfo.new(
      :poi_info_id => 1,
      :point_type => "MyString",
      :addr => "MyString",
      :zip => "MyString",
  ...
  it "renders new poi_info form" do
    render

    assert_select "form[action=?][method=?]", poi_infos_path, "post" do
