...
RSpec.describe "poi_amenities/new", type: :view do
  before(:each) do
    assign(:poi_amenity, PoiAmenity.new(
      :poi_info_id => 1,
      :ada => 1,
      :bike_parking => 1,
      :bike_rental => 1,
  ...
  it "renders new poi_amenity form" do
    render

    assert_select "form[action=?][method=?]", poi_amenities_path, "post" do
