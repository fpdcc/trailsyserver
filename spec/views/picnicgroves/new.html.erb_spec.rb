...
RSpec.describe "picnicgroves/new", type: :view do
  before(:each) do
    assign(:picnicgrofe, Picnicgrofe.new(
      :picnicgrove_id => "",
  ...
  it "renders new picnicgrofe form" do
    render

    assert_select "form[action=?][method=?]", picnicgroves_path, "post" do
