...
RSpec.describe "parking_entrance_infos/new", type: :view do
  before(:each) do
    assign(:parking_entrance_info, ParkingEntranceInfo.new(
  ...
  it "renders new parking_entrance_info form" do
    render

    assert_select "form[action=?][method=?]", parking_entrance_infos_path, "post" do
